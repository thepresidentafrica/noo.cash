...
<template>
              ...
              <div class="border-b border-gray-200">
                <div class="flex h-16 items-center justify-between">
                  ...
                  <div class="hidden lg:flex lg:flex-1 lg:items-center">
                    <a href="#">
                      <span class="sr-only capitalize">sombatout</span>
                      <img class="h-8 w-auto" src="/sombatout.svg" alt="" />
                    </a>
                  </div>
                  ...
                  <a href="#" class="lg:hidden">
                    ...
                    <img src="/sombatout.svg" alt="" class="h-8 w-auto" />
                  </a>
  ...
  <script setup>
  import { ref } from 'vue'
import sombatout from '../public/sombatout.png';
  import {
    Dialog,
    DialogPanel,
    Popover,
  ...
  const currencies = ['USD', 'CAD', 'AUD', 'EUR', 'GBP',"ZAR","MWK"]
  const navigation = {
    categories: [
      {
        name: 'nearby',
