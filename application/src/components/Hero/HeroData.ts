export const HERO_DATA = {
    ...
    description:
      'Make instant cashless payments at any store or online. noo.cash revolutionizes the way you pay, providing a seamless and secure experience without the need for physical cash.',
    cta: {
      label: 'Get Started',
      url: '/auth/register',
    },
    image: {
      src: '/social/noocash-social.png',
      alt: 'Payment Image',
    },
    features: [
      {
        title: 'Airtime-Powered Transactions:',
        description:`Noo.Cash introduces a groundbreaking feature that allows you to pay with your phone's airtime. Say goodbye to traditional payment methods and embrace the simplicity and innovation of paying directly with your mobile balance. This unique functionality sets Noo.Cash apart, providing users with a convenient and novel way to make transactions. Embrace the future of mobile payments with Noo.Cash.`
      },
      {
        title: 'Smart Savings and Rewards:',
