globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Users/mitchchimwemwechanza/Work/noo/enginear/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createError, useSession, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, getResponseStatusText } from 'file:///Users/mitchchimwemwechanza/Work/noo/enginear/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/mitchchimwemwechanza/Work/noo/enginear/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/mitchchimwemwechanza/Work/noo/enginear/node_modules/devalue/index.js';
import { renderToString } from 'file:///Users/mitchchimwemwechanza/Work/noo/enginear/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file:///Users/mitchchimwemwechanza/Work/noo/enginear/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/mitchchimwemwechanza/Work/noo/enginear/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Users/mitchchimwemwechanza/Work/noo/enginear/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/mitchchimwemwechanza/Work/noo/enginear/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/mitchchimwemwechanza/Work/noo/enginear/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///Users/mitchchimwemwechanza/Work/noo/enginear/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///Users/mitchchimwemwechanza/Work/noo/enginear/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1 } from 'file:///Users/mitchchimwemwechanza/Work/noo/enginear/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///Users/mitchchimwemwechanza/Work/noo/enginear/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///Users/mitchchimwemwechanza/Work/noo/enginear/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/mitchchimwemwechanza/Work/noo/enginear/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/mitchchimwemwechanza/Work/noo/enginear/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/mitchchimwemwechanza/Work/noo/enginear/node_modules/radix3/dist/index.mjs';
import { version, unref } from 'file:///Users/mitchchimwemwechanza/Work/noo/enginear/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/mitchchimwemwechanza/Work/noo/enginear/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/mitchchimwemwechanza/Work/noo/enginear/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/mitchchimwemwechanza/Work/noo/enginear/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/mitchchimwemwechanza/Work/noo/enginear","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/mitchchimwemwechanza/Work/noo/enginear/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/mitchchimwemwechanza/Work/noo/enginear/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/mitchchimwemwechanza/Work/noo/enginear/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/mitchchimwemwechanza/Work/noo/enginear/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _AAxQ5UYv8u = (function(nitro) {
...
function _useSession(event) {
  if (!sessionConfig) {
    sessionConfig = defu$1({ password: process.env.NUXT_SESSION_PASSWORD }, useRuntimeConfig(event).session);
  }
  return useSession(event, sessionConfig);
}

const _1a7suI = eventHandler(async (event) => {
  await clearUserSession(event);
  return { loggedOut: true };
});

const _gZaGii = eventHandler(async (event) => {
  return await requireUserSession(event);
});

const _lazy_QOJUgy = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_QOJUgy, lazy: true, middleware: false, method: undefined },
  { route: '/api/_auth/session', handler: _1a7suI, lazy: false, middleware: false, method: "delete" },
  { route: '/api/_auth/session', handler: _gZaGii, lazy: false, middleware: false, method: "get" },
  { route: '/**', handler: _lazy_QOJUgy, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file:///Users/mitchchimwemwechanza/Work/noo/enginear/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/mitchchimwemwechanza/Work/noo/enginear/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
